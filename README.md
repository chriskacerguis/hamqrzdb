...
```bash
docker compose exec -it api /app/hamqrzdb-process --full --db /data/hamqrzdb.sqlite
```
```bash
# process LA
docker compose exec -it api /app/hamqrzdb-process --la-file /data/LA.dat --db /data/hamqrzdb.sqlite
```
